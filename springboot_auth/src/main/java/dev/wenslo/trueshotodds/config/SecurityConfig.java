        ...
        return http
                ...
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers(
                                ...
                                "/oauth2/**",
                                "/login/oauth2/**",
                                "/api/polls/leaderboard",
                                "/api/polls",
                                "/api/polls/create", // ALLOWED TO LET PYTHON FASTAPI CALL THIS ENDPOINT
                                "/api/polls/expired", // ALLOWED TO LET PYTHON FASTAPI CALL THIS ENDPOINT
                                "/api/polls/closed", // ALLOWED TO LET PYTHON FASTAPI CALL THIS ENDPOINT
                                "/api/polls/*/mark-inactive" // ALLOWED TO LET PYTHON FASTAPI CALL THIS ENDPOINT
                        ).permitAll()
                ...
                .csrf(csrf -> csrf
                        ...
                        .ignoringRequestMatchers("/api/auth/**", "/api/payments/**", "/api/profile/**", "/api/bets/**", "/api/polls/**")
                )
