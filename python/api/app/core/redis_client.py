"""
Redis client for caching FastAPI responses.
Shares Redis instance with Spring Boot using different key prefixes.
"""
...
class RedisClient:
    ...
    async def set(self, key: str, value: Any, ttl: int = settings.CACHE_TTL_MEDIUM) -> bool:
